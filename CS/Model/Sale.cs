...
namespace Model{
	public class Sale : Transaction{
		...
		public Sale(List<Product> product, DateTime transactionDate, List<int> productQuantity, DateTime expirationDate): base(product, transactionDate, productQuantity){
		}
